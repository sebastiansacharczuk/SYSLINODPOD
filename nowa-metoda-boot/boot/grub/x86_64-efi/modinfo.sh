...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib64/gcc/x86_64-slackware-linux/11.2.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
